...
function About() {
  ...
  const resume_download = () => {
    ...
    link.href = "http://localhost:3000/DivyaSoniResume.pdf";
      ...
      <div className="about-right right" ref={rightDivRef}>
        <div className="about-me-box">
          ...
          <div className="about-me-box-bottom">
            <p>
              I am a recent software Engineer graduate on an unwavering quest
              for knowledge in frontend development. Passionate about creating
              intuitive user interfaces, my journey has led me to explore React
              and its principle,developing ReactJS components,Routing , virtual
              DOM , workflow and constantly seeking to enhance my skills
            </p>
            <p>
              {" "}
              Additionally, I have also worked on python for machine learning
              and web scraping,hands-on experience with C++, where I've tackled
              diverse challenges. Navigating through the world of databases,
              I've proficiently managed SQL and MongoDB.
            </p>
          </div>
        </div>
      </div>
